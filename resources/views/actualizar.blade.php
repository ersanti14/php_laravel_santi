            ...
            <div
                ...
                <form method="POST" action="{{ route('editar',$users->id) }}">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" id="nombre" value="{{$users->name}}"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="telefono" id="telefono" value="{{$users->telefono}}"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="direccion" id="direccion" value="{{$users->direccion}}"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    ...
                    <input type="submit" value="Actualizar Usuario"
                        ...
                        <a href="{{route('export_user',$users->id)}}" class="rounded text-sm hover:bg-rose-800 bg-rose-600 p-3 text-white font-bold">Exportar Usuarios</a>
                    </form>
            </div>
        </div>
    </div>
